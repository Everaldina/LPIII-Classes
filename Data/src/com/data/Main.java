...
public class Main {
    ...
    public static void main(String[] args) {
        Data data1 = new Data((byte)12,(byte)4,(short)2022);
        Data data2 = new Data((byte)10,(byte)5,(short)2022);
        ...
        if(data1.eAnterior(data2))
            ...
            System.out.println(data1.printData()+" vem antes que "+data2.printData());
